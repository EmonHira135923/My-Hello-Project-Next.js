...
export default async function  StoryDetails({ params }) {
    const story = devStories.find(async (s) => s.id === await parseInt(params.id));
  ...
  return (
    <div className="max-w-9xl mx-auto bg-black text-white shadow-md rounded-lg p-6 border border-gray-200">
      {/* Top Section */}
