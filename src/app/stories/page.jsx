"use client";
import StoryCard from "@/Componets/Card/StoryCard";
    ...
    <div className="min-h-screen bg-slate-950 px-8 py-12 max-w-9xl mx-auto">
      <header className="mb-12 border-l-4 border-cyan-500 pl-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">
            Our <span className="text-cyan-400">Stories</span>
          </h1>
          <div className="flex items-center gap-3 mt-3">
            <span className="flex h-2 w-2 rounded-full bg-cyan-500 animate-ping" />
            <p className="text-slate-400 font-medium">
              Discover {devStories.length} unique developer journeys
            </p>
          </div>
        </header>
      {/* This container handles the 1 column on mobile and 3 columns on large screens */}
